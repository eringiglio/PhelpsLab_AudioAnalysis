function [call_list, parameters, call_stats, call_stat_labels, note_labels] = ...
    msr_all_batch_AL_B(xl_file, output_file, range, anal_param, methods)

[param_list, call_list] = xlsread(xl_file);

[num_rows, c] = size(call_list);
...
for i =1:num_calls
    ...
    [call_stats(i,:), call_stat_labels, all_notes_matrix, note_labels] = ...
        msr_all_AL(call, samp_rate, threshold, reset, time_code, curve_meth, INI_max, fig_on, call_id);
